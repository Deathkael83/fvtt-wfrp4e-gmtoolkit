...
// let packsouce = ["wfrp4e-core", "wfrp4e-gm-toolkit-dk-fix", "wfrp4e-eis-maps"] // Explicitly specify pack sources to only toggle their visiblity (eg, only show/hide packs from the wfrp4e-core module)
